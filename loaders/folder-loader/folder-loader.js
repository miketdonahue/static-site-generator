...
rimraf.sync(path.join(cwd, config.output.path.images));
fs.mkdirSync(path.join(cwd, config.output.path.images));

// Refresh public css directory
rimraf.sync(path.join(cwd, config.output.path.css));
fs.mkdirSync(path.join(cwd, config.output.path.css));

// Refresh public javascript directory
rimraf.sync(path.join(cwd, config.output.path.js));
fs.mkdirSync(path.join(cwd, config.output.path.js));
